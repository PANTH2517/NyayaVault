...
export const AboutView: React.FC = () => {
  const flowSteps = [
    ...
    { num: '05', title: 'CALCULATE SHA-256', desc: 'Live SHA-256 hash computed from binary payload bytes', icon: ShieldCheck },
    { num: '06', title: 'VERSION DOCUMENT', desc: 'Immutable version created & stored in Supabase Private Storage', icon: GitCommit },
    ...
    { num: '09', title: 'AUDIT', desc: 'Action recorded in hash-chained audit ledger H_n', icon: History },
